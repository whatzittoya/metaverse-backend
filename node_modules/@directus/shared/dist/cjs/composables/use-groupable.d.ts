import { Ref } from 'vue';
export declare type GroupableInstance = {
    active: Ref<boolean>;
 ...
 */
declare type GroupableOptions = {
    value?: string | number;
    group?: string;
    active?: Ref<boolean>;
    watch?: boolean;
};
declare type UsableGroupable = {
    active: Ref<boolean>;
    toggle: () => void;
    activate: () => void;
    deactivate: () => void;
...
declare type GroupableParentState = {
...
declare type GroupableParentOptions = {
    mandatory?: Ref<boolean>;
    max?: Ref<number>;
    multiple?: Ref<boolean>;
};
declare type UsableGroupableParent = {
