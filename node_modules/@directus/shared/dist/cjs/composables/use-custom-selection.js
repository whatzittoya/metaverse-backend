...
exports.useCustomSelectionMultiple = exports.useCustomSelection = void 0;
const nanoid_1 = require("nanoid");
const vue_1 = require("vue");
function useCustomSelection(currentValue, items, emit) {
    const localOtherValue = (0, vue_1.ref)('');
    const otherValue = (0, vue_1.computed)({
        get() {
    ...
    const usesOtherValue = (0, vue_1.computed)(() => {
        if (items.value === null)
            return false;
...
exports.useCustomSelection = useCustomSelection;
function useCustomSelectionMultiple(currentValues, items, emit) {
    const otherValues = (0, vue_1.ref)([]);
    (0, vue_1.watch)(currentValues, (newValue) => {
        if (newValue === null)
            return;
    ...
    function setOtherValue(key, newValue) {
        ...
        const valueWithoutPrevious = (currentValues.value || []).filter((val) => val !== (previousValue === null || previousValue === void 0 ? void 0 : previousValue.value));
        if (newValue === null) {
...
exports.useCustomSelectionMultiple = useCustomSelectionMultiple;
