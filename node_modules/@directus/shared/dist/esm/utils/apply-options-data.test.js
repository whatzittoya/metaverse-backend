...
describe('applyOptionsData', () => {
    ...
    it('returns the unchanged options if there are no mustaches', () => {
        expect(applyOptionsData({ str: 'num', arr: ['arr', { null: null }], obj: { str: 'obj', num: 42 } }, { num: 42, arr: ['foo', 'bar'], obj: { foo: 'bar' } })).toEqual({ str: 'num', arr: ['arr', { null: null }], obj: { str: 'obj', num: 42 } });
    });
    it('returns the options with any raw template replaced by the value in scope', () => {
        expect(applyOptionsData({ str: '{{ num }}', arr: ['{{ arr }}', { null: null }], obj: { str: '{{ obj }}', num: 42 } }, { num: 42, arr: ['foo', 'bar'], obj: { foo: 'bar' } })).toEqual({ str: 42, arr: [['foo', 'bar'], { null: null }], obj: { str: { foo: 'bar' }, num: 42 } });
    });
    it('returns the options with any non-raw template rendered with the respective stringified values from the scope', () => {
        expect(applyOptionsData({ str: 'num: {{ num }}', arr: ['arr: {{ arr }}', { null: null }], obj: { str: 'obj: {{ obj }}', num: 42 } }, { num: 42, arr: ['foo', 'bar'], obj: { foo: 'bar' } })).toEqual({
            str: 'num: 42',
    ...
    it('returns the options with non-raw templates which reference null or undefined scope values as literal null and undefined strings', () => {
        expect(applyOptionsData({ null: 'null: {{ null }}', undefined: 'undefined: {{ undefined }}' }, { null: null })).toEqual({
            null: 'null: null',
